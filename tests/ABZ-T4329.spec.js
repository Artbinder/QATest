...
test('ABZ-T4329: [TC-02-PROD] User can add objects to transaction with "Add Objects" option', async ({ page }) => {
  ...
  // Navigate to Transactions (Sales) page
  ...
  await page.locator('.x-nav-more').getByRole('link', { name: 'Sales' }).click();
  ...
  // Now we should be on the sale transaction page with the object already added
